...
int main() {
  ...
  // Declare and initialize an array to store the unique elements in the union of the sets
  int unique_elements[MAX_ELEMENT + 1] = {0};

  // Mark the elements that appear in set 1 as present in the unique elements array
  for (int i = 0; i < SET_SIZE; i++) {
    unique_elements[set1[i]] = 1;
  }

  // Mark the elements that appear in set 2 as present in the unique elements array
  for (int i = 0; i < SET_SIZE; i++) {
    unique_elements[set2[i]] = 1;
  }

  // Print the unique elements in the union of the sets
  printf("Unique elements in the union of the sets:\n");
